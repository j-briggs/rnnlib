...
A visual studio solution in the ide/rnnlib_vs2013 directory. The required dll's are in the debug and release directories also. You will need to change the VC Directories to point to your Boost include and lib directories.

The original project was released under a GPLv3 license, and the same applies here. All credit and bug reports should go to Alex Graves.
